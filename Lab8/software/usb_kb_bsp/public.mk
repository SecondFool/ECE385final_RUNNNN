...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100011f8
SOPC_SYSID_FLAG += --sidp=0x100011f8
ELF_PATCH_FLAG  += --sidp 0x100011f8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1599632676
SOPC_SYSID_FLAG += --timestamp=1599632676
ELF_PATCH_FLAG  += --timestamp 1599632676
